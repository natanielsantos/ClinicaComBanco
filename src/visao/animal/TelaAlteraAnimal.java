...
public class TelaAlteraAnimal extends javax.swing.JFrame {

    private Cliente cli;
    private Animal ani;
    private GerenciaCliente gc;
    private GerenciaAnimal ga;
    TelaAlteraAnimal tcAnimal;

    public TelaAlteraAnimal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAlteraAnimal = new javax.swing.JButton();
        ...
        jLabel1.setText("Ficha Animal - Alterar Dados ");
        ...
        btnAlteraAnimal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Checked-Checkbox-32.png"))); // NOI18N
        btnAlteraAnimal.setText("Salvar alteração");
        btnAlteraAnimal.setEnabled(false);
        btnAlteraAnimal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAlteraAnimalActionPerformed(evt);
            }
        });
    ...
    private void buttonBuscaClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBuscaClienteActionPerformed
        ...
        if (ani != null) {
            ...
            btnAlteraAnimal.setEnabled(true);
        } else {
    ...
    private void btnAlteraAnimalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlteraAnimalActionPerformed
        ...
        ani.setNomeAnimal(tfNomeAnimal.getText());
        ani.setCorPelagem(tfCor.getText());
        ani.setEspecie(tfEspecie.getText());
        ani.setSexo((String) cbSexo.getSelectedItem());
        //ani.setDataNascimento(tfDataNascimento.getText()); // TODO converter para date
        ani.setRaca(tfRaca.getText());
        ani.setPeso(Double.parseDouble(jtPeso.getText()));
        ani.setObs(jtObs.getText());
        ...
        this.dispose();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao alterar o animal!");
        }
            
    }//GEN-LAST:event_btnAlteraAnimalActionPerformed
    ...
    private javax.swing.JButton btnAlteraAnimal;
