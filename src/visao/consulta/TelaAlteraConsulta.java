 ...
 * @author Aluno
 */
public class TelaAlteraConsulta extends javax.swing.JFrame {
    ...
    public TelaAlteraConsulta(Consulta c) {
    ...
    private void jbuttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonCadastrarActionPerformed
        ...
        consulta.setDataConsulta(dConsulta);
        consulta.setHoraConsulta(jcHora.getSelectedItem().toString());
        consulta.setIdAnimal(animal);
        consulta.setServico((String) jcListaServicos.getSelectedItem());
        consulta.setValor(Double.parseDouble(jfValor.getText()));
        consulta.setDiagnostico(jtDiagnostico.getText());
        
        try {
            gct.alterar(consulta);
        } catch (Exception ex) {
            Logger.getLogger(TelaAlteraConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
