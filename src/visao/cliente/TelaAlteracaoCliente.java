...
public class TelaAlteracaoCliente extends javax.swing.JFrame {
   ...
   EntityManagerFactory emf = Persistence.createEntityManagerFactory("ClinicaComBancoPU");
    ...
    public TelaAlteracaoCliente(int id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ficha de Cliente - Alterar");

        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel2.setToolTipText("Cliente");
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jbAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Reviewer-32.png"))); // NOI18N
        ...
        jPanel2.add(jbAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, -1, -1));
    ...
    private void jbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAlterarActionPerformed
        ...
        try {
            ...
            cli.setNomeCli(tfNome.getText());
            cli.setCpfCli(tfCPF.getText());
            cli.setRgCli(tfRG.getText());
            cli.setSexoCli((String) jcSexo.getSelectedItem());
            cli.setDtNascCli(cfg.formataData(tfData.getText()));
            cli.setLgrCli(tfLogradouro.getText());
            cli.setNumCli(tfNumero.getText());
            cli.setCidCli(tfCidade.getText());
            cli.setEstCli((String) jcEstado.getSelectedItem());
            cli.setTel1Cli(tfTelefone.getText());
            cli.setTel2Cli(tfTelefone1.getText());
